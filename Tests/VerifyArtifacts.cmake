if(NOT DEFINED ADATTYPEI_STAGED_DIR)
    message(FATAL_ERROR "ADATTYPEI_STAGED_DIR is required")
endif()

set(vst3 "${ADATTYPEI_STAGED_DIR}/VST3/AdatTypeI.vst3")
if(ADATTYPEI_EXPECT_AU)
    set(standalone "${ADATTYPEI_STAGED_DIR}/Standalone/AdatTypeI.app")
elseif(WIN32)
    set(standalone "${ADATTYPEI_STAGED_DIR}/Standalone/AdatTypeI.exe")
else()
    set(standalone "${ADATTYPEI_STAGED_DIR}/Standalone/AdatTypeI")
endif()
...
if(ADATTYPEI_EXPECT_AU)
    set(au "${ADATTYPEI_STAGED_DIR}/AU/AdatTypeI.component")
